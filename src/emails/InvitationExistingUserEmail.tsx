...
export interface InvitationExistingUserEmailProps {
  businessName: string;
  role: string;
  inviterName: string;
  acceptUrl: string;
...
export function InvitationExistingUserEmail(
  props: InvitationExistingUserEmailProps
) {
  const { businessName, role, inviterName, acceptUrl, expiryDays } = props;

  return (
    <BaseLayout previewText={`${inviterName} invited you to join ${businessName}`}>
...
export default InvitationExistingUserEmail;
